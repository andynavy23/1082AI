...
6. 新增規則至資料庫（單筆規則新增）
    - [網頁表單](https://ai1082.herokuapp.com/Admin)使用GET Form，需要填入關鍵字、規則、輸出等資訊
    ![網頁表單](/img/網頁表單.png)
    - 關鍵字1：通知
...
8. 接收使用者上傳檔案（網頁上傳）
     - [檔案上傳頁面](https://ai1082.herokuapp.com)選擇檔案上傳
     ![上傳檔案網頁](/img/上傳檔案網頁.png)
     - 顯示上傳結果  
     ![上傳結果](/img/上傳結果.png)   
     - 透過關鍵字取得下載所有檔案連結  
     ![下載檔案連結](/img/下載檔案連結.png)  
